package com.pg.custom.application.ruler;
...
public class RulerView extends View {
    ...
    private void init() {
        ...
        mScaleHeight = getResources().getDimensionPixelOffset(R.dimen.ruler_height);
     ...
     * @param colorId  刻度颜色
     */
    public void setMaxValueAndPaintColor(float maxValue, int colorId) {
        mMaxValue = maxValue;
        mColorId=colorId;
        init();
    }
    ...
    private float getSecond(float secondInput, int multipe) {
        ...
        int secDecimal = (int) ((secondInput-multipe*5*secInt)*10/5);
        String secStr = secInt + "." + secDecimal;
        float retrunSec = Float.valueOf(secStr).floatValue();
        Log.i("pgtest",retrunSec+"=====retrunSec");
        return retrunSec;
    }
